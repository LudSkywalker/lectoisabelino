                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <a href="../../principal.php#">Send invoice</a></span>
                    ...
                    <tr>
                      <td>
                        <span class="check"><input type="checkbox" class="checked"></span>
                        <a href="../../principal.php#">Check messages</a></span>
                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <span class="check"><input type="checkbox" class="checked"></span>
                        <a href="../../principal.php#">Pay bills</a></span>
                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <span class="check"><input type="checkbox" class="checked"></span>
                        <a href="../../principal.php#">Schedule site </a></span>
                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
                      </td>
                    </tr>
                  </tbody>
